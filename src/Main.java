...
public class Main {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        //System.out.println(allBalancesMapList.get(3).get("Balance") + " " + allBalancesMapList.get(3).get("Currency"));
        //for (int i = 0; i < allBalancesMapList.size(); i++) {
            //System.out.println(allBalancesMapList.get(i).get("Currency") + " " + allBalancesMapList.get(i).get("Balance"));
        //}
...
//        System.out.println(allOrderMapList.get(0).get("Exchange") + " " + allOrderMapList.get(0).get("Quantity"));
